...
class JSplashScreen extends JWindow {
  ...
  private void jbInit() throws Exception {
    ...
    statusField.setFont(new java.awt.Font("Monospaced", 0, 12));
    statusField.setBackground(new Color(217, 210, 223));//217, 210, 158
    statusField.setForeground(new Color(66, 118, 158));
    statusField.setHorizontalAlignment(JTextField.CENTER);
    statusField.setEditable(false);
    statusField.setText(statusMessage);

    imagePanel.setLayout(new BorderLayout());
    imagePanel.setBackground(new Color(0, 0, 138));
    imagePanel.add(imageLabel, BorderLayout.CENTER);

    statusPanel.setLayout(new BorderLayout());
    statusPanel.add(statusField, BorderLayout.CENTER);

    splashScreenPanel.setPreferredSize(new Dimension(333,250));
 ...
 JPanel splashScreenPanel = new JPanel();
  ...
  private String statusMessage = " All Rights Reserved.";
}
