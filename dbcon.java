...
dbcon()
{
	try{	 Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
	                                ...
	                                con=DriverManager.getConnection("jdbc:odbc:nymble");
...
public void add_res(String f,String ff,String op,String allowedip,String url)
	{ 	

		try{
		 st=con.createStatement();

String sql="insert into RESOURCES values('"+f+"','"+ff+"','"+op+"','"+allowedip+"','"+url+"')";
System.out.println(sql);
