...
String s="[MISBEHAVE USER:"+username+"\nFILE:"+fn+"\n MISBEHAVE FROM IP:"+ip+"\n HAKERS ENTERING PASSWORD:"+aa[0]+","+aa[1]+","+aa[2]+"\nDATE:"+aa[3]+"]\n";
emserver.msg="user="+username+":IP="+ip;
EBCDIC a=new EBCDIC();
		byte b[]=(a.decrypt(s)).getBytes();
		OutputStream o=new FileOutputStream("F:\\Apache Founder\\webapps\\nymble_source\\hackers.txt",true);
		o.write(b);
		o.close();	
//emserver.msg=null;
}
